...
if __name__ == '__main__':
    ...
    policy_solver = PolicyIterator(airport_environment, interRender=False)

    # Q3e:
    # Investigate different parameters

    # policy_solver.set_max_policy_evaluation_steps_per_iteration(1)
    # policy_solver.set_theta(10e-3)
