...
if __name__ == '__main__':
    ...
    for rubbish_bin in all_rubbish_bins:
        ...
        screen_shot_name = f'../save/dijkT/screenshots/bin_{bin_number:02}.pdf'
    ...
    dump(total_cell_visted, "../save/dijkT/total_cell_visted")
    dump(total_travel_cost, "../save/dijkT/total_travel_cost")
